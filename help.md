    ...
    <style type="text/css">
        ...
        @media only screen and (max-width: 660px) {
            ...
            td.banner {
                width: 480px;
                height: 150px;
                background: url(img/banner_medium.jpg) no-repeat 0px 0px;
            }
            ...
            td.promos table.promo_1 td {
                background: url(img/promo_1_medium.jpg) no-repeat 0px 0px;
                padding: 100px 0px 0px 0px;
            }
            
            td.promos table.promo_2 td {
                background: url(img/promo_2_medium.jpg) no-repeat 0px 0px;
                padding: 100px 0px 0px 0px;
            }
            ...
            td.callout table.callout_1 td {
                ...
                background: url(img/icon_grapes.gif) no-repeat 0px -13px;
            }
            
             td.callout table.callout_2 td {
                padding: 0px 20px 0px 60px !important;
                background: url(img/icon_bottle.gif) no-repeat 10px -3px;
            }
            
             td.callout table.callout_3 td {
                padding: 0px 30px 0px 60px !important;
                background: url(img/icon_basket.gif) no-repeat 0px -13px;
                 clear: left;
            }
            
             td.callout table.callout_4 td {
                padding: 0px 20px 0px 60px !important;
                background: url(img/icon_camera.gif) no-repeat 10px -13px;
            }
        }
        ...
        @media only screen and (max-width: 510px) {
            ...
            td.logo {
                background: #fff url(img/logo_small.gif) no-repeat 10px;
                height: 32px;
            }
            ...
            td.banner {
                height: 115px;
                background: url(img/banner_small.jpg) no-repeat right 0px;
            }
            
            td.contnet {
                line-height: 20px !important;
                padding-bottom: 10px !important;
                background: #f5f2e5 url(img/banner_small_ghost.jpg) no-repeat right 0px !important; 
            }
            ...
            td.promos table.promo_1 td {
                background: url(img/promo_1_small.jpg) no-repeat 0px 40px;
            ...
            td.promos table.promo_2 td {
                background: url(img/promo_2_small.jpg) no-repeat 0px 20px;
...
<body bgcolor="#efe1b0">
   ...
   <div style="font-size: 1px; color: #efe1b0; display: none">
    ...
    <!-- html goes here -->
    <table width="100%" border="0" cellspacing="0" celpadding="0" bgcolor="#efe1b0">
        <tr>
            <!--/ Main Rows inside it creating containers-->
            <td>
                <table class="container" width="640" align="center" border="0" cellspacing="0" celpadding="0">
                    <!--/ Conatiners-->
                    <tr>
                        <!--Logo Rows-->
                        <td valign="top" class="logo" bgcolor="#fff" style="padding: 10px 20px 0px 30px; border-left: 1px solid #dbc064; border-right: 1px solid #dbc064; border-top: 1px solid #dbc064;">
                            <a href="#"><img style="margin-left: -15px" src="img/logo_large.gif" alt="Our vinyard" width="585" height="45" border="0"> </a>
                        </td>
                    </tr>
                    <!--/ Logo Rows-->
                    ...
                    <tr>
                        ...
                        <td valign="top" class="headline" bgcolor="#ffffff" style="padding: 15px 20px 5px 30px; border-left: 1px solid #dbc064; border-right: 1px solid #dbc064; font-family: Arial, Helvetica, sans-serif; font-size: 16px; line-height: 22px;">
                            <h1 style="margin: 0px 0px 15px 0; font-family: 'Dancing Script', Arial; font-weight: normal; font-size: 32px; color: #723c7f;">Main Heading here</h1>
                        </td>
                    </tr>
                    <!--/ Heading Rows-->
                    ...
                    <tr>
                        ...
                        <td valign="top" bgcolor="#f5f2e5" class="banner" style="border-left: 1px solid #dbc064; border-right: 1px solid #dbc064;">
                            <img src="img/banner_large.jpg" alt="Photo of our vinyard" width="638" height="180">
                        </td>
                    </tr>
                    <!--/ Banners Rows-->
                    ...
                    <tr>
                        <!--Content Rows-->
                        <td valign="top" bgcolor="#f5f2e5" class="content" style="padding: 30px 30px 10px 30px; border-right: 1px solid #dbc064; border-left: 1px solid #dbc064; font-family:Arial, Helvetica, sans-serif; font-size: 16px; line-height:22px; color: #654308; background: #f5f2e5 url(img/banner_large_ghost.jpg) no-repeat 0px 0px">

                            <table width="160px" align="right" ; class="button" style="margin: 0px 0px 10px 30px;">
                                <tr>
                                    <td style="text-align: center; background: #71a412; padding: 10px 15px; border-radius: 5px;">
                            ...
                            Enjoy,
                            <br>
                            <img src="img/chris.gif" alt="Chris" width="90" height="40">
                        </td>
                    </tr>
                    <!--/ Content Rows-->
                    ...
                    <tr>
                        ...
                        <td valign="top" bgcolor="#f5f2e5" class="promos" style="padding: 10px 30px 25px 30px; border-right:1px solid #dbc064; border-left:1px solid #dbc064; background-color: #f5f2e5; font-family: Arial, Helvetica, sans-serif;">
                            <table class="promo_1" width="270" align="left">
                                <tr>
                                    <td>
                                        <img class="promo" alt="Promo image 1" src="img/promo_1_large.jpg">
                                        ...
                                        <br><br>
                                        <a href="#" style="background-color: #71a412; text-decoration: none; padding: 5px 10px 5px 10px; border-radius: 5px; color: #fff; text-shadow: 0 2px 2px #3a6506;">Learn more</a>
                                    </td>
                                </tr>
                            </table>
                            ...
                            <table class="promo_2" width="270" align="right">
                                <tr>
                                    <td>
                                        <img class="promo" alt="Promo image 2" src="img/promo_2_large.jpg">
                                        <h3 style="font-size:16px;">Promo heading here</h3>
                                        Lorem ipsum dolor sit amet consectetur incididunt ut labore et dolore magna aliqua elit sed do eiusmod.
                                        <br><br>
                                        <a href="#" style="background-color: #71a412; text-decoration: none; padding: 5px 10px 5px 10px; border-radius: 5px; color: #fff; text-shadow: 0 2px 2px #3a6506;">Learn more</a>
                    ...
                    <tr>
                        ...
                        <td valign="top" bgcolor="#55315d" class="callout" style="background-color: #55315d; padding: 30px; border-right: 1px solid #dbc064; border-bottom: 1px solid #dbc064; border-left: 1px solid #dbc064;">
                            <table class="callout_1" width="135" align="left" border="0" cellspacing="0" cellpadding="0">
                                <tr>
                                    <td valign="top" width="135" style="padding-left: 10px; padding-right: 10px; font-family:Arial, Helvetica, sans-serif; font-size:13px; line-height: 16px; color: #ffffff;">
                                        <img alt="Grapes" src="img/icon_grapes.gif" width="75" height="75"><br>
                            ...
                            <table class="callout_2" width="135" align="left" border="0" cellspacing="0" cellpadding="0">
                                <tr>
                                    <td valign="top" width="135" style="padding-left: 10px; padding-right: 10px; font-family:Arial, Helvetica, sans-serif; font-size:13px; line-height: 16px; color: #ffffff;">
                                        <img alt="Bottle" src="img/icon_bottle.gif" width="75" height="75"><br>
                            ...
                            <table class="callout_3" width="135" align="left" border="0" cellspacing="0" cellpadding="0">
                                <tr>
                                    <td valign="top" width="135" style="padding-left: 10px; padding-right: 10px; font-family: Arial, Helvetica, sans-serif; font-size: 13px; line-height: 16px; color: #ffffff;">
                                        <img alt="Basket" src="img/icon_basket.gif" width="75" height="75"><br>
                            ...
                            <table class="callout_4" width="135" align="left" border="0" cellspacing="0" cellpadding="0">
                                <tr>
                                    <td valign="top" width="135" style="padding-left: 10px; padding-right: 10px; font-family: Arial, Helvetica, sans-serif; font-size: 13px; line-height: 16px; color: #ffffff;">
                                        <img alt="Camera" src="img/icon_camera.gif" width="75" height="75"><br>
